...
class MyTestCase(unittest.TestCase):
    ...
    def test_app_budget_add(self):
        time.sleep(2)
        budget = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/menu')
        budget.click()
        time.sleep(2)
        add_budget = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/action_add')
        add_budget.click()
        time.sleep(2)
        type_budget = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/budgetName')
    ...
    def test_app_budget_add_transaction(self):
        ...
        transactions.click()
        time.sleep(2)
        add_transactions = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/action_add')
        add_transactions.click()
        time.sleep(2)
        add_name = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/name')
        add_name.send_keys('Tony Hawks')
        time.sleep(2)
        add_account = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/account')
        add_account.send_keys('noo')
        time.sleep(2)
        add_value = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/value')
        add_value.send_keys('123')
        time.sleep(2)
        add_note = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/note')
    ...
    def test_app_budget_change_quality(self):
        time.sleep(2)
        settings = self.driver.find_element(AppiumBy.ID,'protect.budgetwatch:id/action_settings')
        settings.click()
        time.sleep(2)
